...
plugins=(heroku git ruby text mate ruby lighthouse osx colorize copydir copyfile cp debian encode64 extract mercurial profiles rvm tmux systemd zsh-syntax-highlighting)
